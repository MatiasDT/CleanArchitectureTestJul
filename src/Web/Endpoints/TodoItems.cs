...
using CleanArchitectureTestJul.Application.TodoItems.Commands.CreateTodoItem;
using CleanArchitectureTestJul.Application.TodoItems.Commands.DeleteTodoItem;
using CleanArchitectureTestJul.Application.TodoItems.Commands.UpdateTodoItem;
using CleanArchitectureTestJul.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CleanArchitectureTestJul.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace CleanArchitectureTestJul.Web.Endpoints;
